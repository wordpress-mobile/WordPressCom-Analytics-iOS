...
typedef NS_ENUM(NSUInteger, WPAnalyticsStat) {
    ...
    WPAnalyticsStatLoginMagicLinkOpenFormViewed,
    ...
    WPAnalyticsStatLoginPasswordRetryViewed,
    WPAnalyticsStatLoginPrologueViewed,
    WPAnalyticsStatLoginTwoFactorFormViewed,
    WPAnalyticsStatLoginURLFormViewed,
    WPAnalyticsStatLoginURLHelpViewed,
    WPAnalyticsStatLoginURLRetryViewed,
    WPAnalyticsStatLoginUsernamePasswordFormViewed,
    WPAnalyticsStatLoginUsernamePasswordRetryViewed,
